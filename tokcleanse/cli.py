...
def train_command(
    ...
    combined_loss: bool = typer.Option(
        False,
        "--combined-loss/--no-combined-loss",
        help="Backprop the full combined task+router objective through both trainable model and router parameter groups.",
    ),
    max_length: int = typer.Option(
        1024,
        "--max-length",
    ...
    frozen_learning_rate: float = typer.Option(
        0.0,
        "--frozen-learning-rate",
        help="Constant learning rate for otherwise frozen parameters and rows. Use 0 to freeze them completely.",
    ),
    ...
    return json.dumps(
        {
            "dry_run": {
                ...
                "combined_loss": report.combined_loss,
                ...
                "frozen_learning_rate": report.frozen_learning_rate,
